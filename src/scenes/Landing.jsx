...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id="home"
      className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10  max-w-[1440px]"
    >
      {/* IMAGE SECTION */}
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          Hello. I am a professional video editor and have been doing this job for 5 years. Since I have been in this field for a long time, I know how to edit a video and its nuances. I have also been involved in logo design for 2 years
          </p>
        </motion.div>
